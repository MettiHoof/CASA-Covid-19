##############################################################################################
# -*- coding: utf-8 -*-
# Script to read in and visualise occupation and essential flow data we are going to use to study Covid with Quant
...
#
# FlowsEssentialRoad.csv
# FlowsEssentialBus.csv
# FlowsEssentialRail.csv
#
#
# Structure: MSOA_i, MSOA_j, non_essential_workers_by_occupation1(O1), non_essential_workers (O2),..., 
#	essential_workers_by_occupation1(EO1), essential_workers_by_occ2 (EO2), ...,essential_workers_by_occ9 (EO9)
# Essential flows are calculated on a pro-rata basis per region. For example EO2 is 0.194 of all workers, and this for all MSOAs in a certain region. 
#
...
inputfile_Ess_car= foldername_input + 'flowEssentialRoad.csv' 
inputfile_Ess_bus= foldername_input + 'flowEssentialBus.csv'
inputfile_Ess_rail= foldername_input + 'flowEssentialRail.csv' 
...
#Csv file with average trip length by MSOAs per occupation
inputfile_trip_length='/Users/Metti_Hoof/Desktop/Quant_Covid_work/Data/avg_trip_length_by_occ_by_region2.csv'
...
while Ess:
	...
	while car:
		...
		infile = open(inputfile_Ess_car)
		df_Ess_car=pd.read_csv(infile, sep=',', lineterminator='\n')
	...
	while bus:
		...
		df_Ess_bus=df_Ess_bus.rename(columns={'o': 'Origin','d':'Destination','EO9\r': 'EO9'})
	...
	while rail:
		...
		df_Ess_rail=df_Ess_rail.rename(columns={'o': 'Origin','d':'Destination','EO9\r': 'EO9'})
...
######################
#1.2.7 Average trip lengths by occupation
######################
...
############################
#4.1 Calculate the total amount of workers per occupation
############################
#Oi + EOi = Total amount of workers.

df_Ess_car['O1_total']=df_Ess_car['O1']+df_Ess_car['EO1']
df_Ess_car['O2_total']=df_Ess_car['O2']+df_Ess_car['EO2']
df_Ess_car['O3_total']=df_Ess_car['O3']+df_Ess_car['EO3']
df_Ess_car['O4_total']=df_Ess_car['O4']+df_Ess_car['EO4']
df_Ess_car['O5_total']=df_Ess_car['O5']+df_Ess_car['EO5']
df_Ess_car['O6_total']=df_Ess_car['O6']+df_Ess_car['EO6']
df_Ess_car['O7_total']=df_Ess_car['O7']+df_Ess_car['EO7']
df_Ess_car['O8_total']=df_Ess_car['O8']+df_Ess_car['EO8']
df_Ess_car['O9_total']=df_Ess_car['O9']+df_Ess_car['EO9']

df_Ess_bus['O1_total']=df_Ess_bus['O1']+df_Ess_bus['EO1']
df_Ess_bus['O2_total']=df_Ess_bus['O2']+df_Ess_bus['EO2']
df_Ess_bus['O3_total']=df_Ess_bus['O3']+df_Ess_bus['EO3']
df_Ess_bus['O4_total']=df_Ess_bus['O4']+df_Ess_bus['EO4']
df_Ess_bus['O5_total']=df_Ess_bus['O5']+df_Ess_bus['EO5']
df_Ess_bus['O6_total']=df_Ess_bus['O6']+df_Ess_bus['EO6']
df_Ess_bus['O7_total']=df_Ess_bus['O7']+df_Ess_bus['EO7']
df_Ess_bus['O8_total']=df_Ess_bus['O8']+df_Ess_bus['EO8']
df_Ess_bus['O9_total']=df_Ess_bus['O9']+df_Ess_bus['EO9']

df_Ess_rail['O1_total']=df_Ess_rail['O1']+df_Ess_rail['EO1']
df_Ess_rail['O2_total']=df_Ess_rail['O2']+df_Ess_rail['EO2']
df_Ess_rail['O3_total']=df_Ess_rail['O3']+df_Ess_rail['EO3']
df_Ess_rail['O4_total']=df_Ess_rail['O4']+df_Ess_rail['EO4']
df_Ess_rail['O5_total']=df_Ess_rail['O5']+df_Ess_rail['EO5']
df_Ess_rail['O6_total']=df_Ess_rail['O6']+df_Ess_rail['EO6']
df_Ess_rail['O7_total']=df_Ess_rail['O7']+df_Ess_rail['EO7']
df_Ess_rail['O8_total']=df_Ess_rail['O8']+df_Ess_rail['EO8']
df_Ess_rail['O9_total']=df_Ess_rail['O9']+df_Ess_rail['EO9']
...
if car:
	# For the origin, which in our data is the location of the workplace
	df_aggregated_Ess_car_origin=df_Ess_car.groupby(['Origin'])[['O1','O2','O3','O4','O5','O6','O7','O8','O9','EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9','O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].agg('sum').copy()
	df_aggregated_Ess_car_origin['sum_occ_non_ess']=df_aggregated_Ess_car_origin[['O1','O2','O3','O4','O5','O6','O7','O8','O9']].sum(axis=1)
	df_aggregated_Ess_car_origin['sum_occ_ess']=df_aggregated_Ess_car_origin[['EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9']].sum(axis=1)
	df_aggregated_Ess_car_origin['sum_occ_total']=df_aggregated_Ess_car_origin[['O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].sum(axis=1)
	
	# For the destination, which in our data is the location of the home
	df_aggregated_Ess_car_destination=df_Ess_car.groupby(['Destination'])[['O1','O2','O3','O4','O5','O6','O7','O8','O9','EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9','O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].agg('sum').copy()
	df_aggregated_Ess_car_destination['sum_occ_non_ess']=df_aggregated_Ess_car_destination[['O1','O2','O3','O4','O5','O6','O7','O8','O9']].sum(axis=1)
	...
	df_aggregated_Ess_car_destination['sum_occ_total']=df_aggregated_Ess_car_destination[['O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].sum(axis=1)
	

#For bus
if bus:
	# For the origin, which in our data is the location of the workplace
	df_aggregated_Ess_bus_origin=df_Ess_bus.groupby(['Origin'])[['O1','O2','O3','O4','O5','O6','O7','O8','O9','EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9','O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].agg('sum').copy()
	df_aggregated_Ess_bus_origin['sum_occ_non_ess']=df_aggregated_Ess_bus_origin[['O1','O2','O3','O4','O5','O6','O7','O8','O9']].sum(axis=1)
	df_aggregated_Ess_bus_origin['sum_occ_ess']=df_aggregated_Ess_bus_origin[['EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9']].sum(axis=1)	
	df_aggregated_Ess_bus_origin['sum_occ_total']=df_aggregated_Ess_bus_origin[['O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].sum(axis=1)
	
	# For the destination, which in our data is the loication of the home
	df_aggregated_Ess_bus_destination=df_Ess_bus.groupby(['Destination'])[['O1','O2','O3','O4','O5','O6','O7','O8','O9','EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9','O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].agg('sum').copy()
	df_aggregated_Ess_bus_destination['sum_occ_non_ess']=df_aggregated_Ess_bus_destination[['O1','O2','O3','O4','O5','O6','O7','O8','O9']].sum(axis=1)
	...
	df_aggregated_Ess_bus_destination['sum_occ_total']=df_aggregated_Ess_bus_destination[['O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].sum(axis=1)
	

#For rail
if rail:
	# For the origin, which in our data is the location of the workplace
	df_aggregated_Ess_rail_origin=df_Ess_rail.groupby(['Origin'])[['O1','O2','O3','O4','O5','O6','O7','O8','O9','EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9','O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].agg('sum').copy()
	df_aggregated_Ess_rail_origin['sum_occ_non_ess']=df_aggregated_Ess_rail_origin[['O1','O2','O3','O4','O5','O6','O7','O8','O9']].sum(axis=1)
	df_aggregated_Ess_rail_origin['sum_occ_ess']=df_aggregated_Ess_rail_origin[['EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9']].sum(axis=1)	
	df_aggregated_Ess_rail_origin['sum_occ_total']=df_aggregated_Ess_rail_origin[['O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].sum(axis=1)
	
	# For the destination, which in our data is the loication of the home
	df_aggregated_Ess_rail_destination=df_Ess_rail.groupby(['Destination'])[['O1','O2','O3','O4','O5','O6','O7','O8','O9','EO1','EO2','EO3','EO4','EO5','EO6','EO7','EO8','EO9','O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].agg('sum').copy()
	df_aggregated_Ess_rail_destination['sum_occ_non_ess']=df_aggregated_Ess_rail_destination[['O1','O2','O3','O4','O5','O6','O7','O8','O9']].sum(axis=1)
	...
	df_aggregated_Ess_rail_destination['sum_occ_total']=df_aggregated_Ess_rail_destination[['O1_total','O2_total','O3_total','O4_total','O5_total','O6_total','O7_total','O8_total','O9_total']].sum(axis=1)
...
ess_list=['essential_workers'] #'essential_workers' non_essential_workers and or'all_workers' 
	...
	for ess in ess_list:
		for occ in occupation_list:
			...
			if direction=='home':
				...
				elif ess=='non_essential_workers':
					title= 'Non-Essential workers: \n' + title
				elif ess=='all_workers':
					title= 'All workers: \n' + title
...
#Set up iteration lists
occupation_list=['O1','O2','O3','O4','O5','O6','O7','O8','O9']
direction_list=['work','home'] #'work' and or 'home'
...
occupation_list=['O1','O2','O3','O4','O5','O6','O7','O8','O9']
# occupation_list=['O1']
direction_list=['home'] #'work' and or 'home'
ess_list=['essential_workers'] #'essential_workers' and or 'all_workers'
...
############################
#5 Visualise the mean trip lengths per occupation and mode 
############################

#We use the avg_trip_length_by_occ_by_region.csv data for this step

########################
#5.1 Join the trip_length file with the geopandas.
########################
...
########################
'''
# Hardcoded limits for the maps. Limits were chosen based on Iacopo's boxplots.
residents_limit=50
workers_limit=50
